...
export const AI_RESEARCH_PROVIDERS: AiProviderConfig[] = [
  ...
  { name: 'finnhub-news', category: 'news', enabled: true, priority: 70, ttlMs: 10 * 60_000 },
  { name: 'yahoo-finance', category: 'fundamental', enabled: true, priority: 90, ttlMs: 10 * 60_000 },
